...
export default async function InvtePage({ params }: InvitePageProps) {
  ...
  const userIsAuthenticateWithSomeEmailInvite =
  ...
  async function signInFromInvite() {
    ...
    cookieStory.set('inviteId', inviteId)
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <div className="flex w-full max-w-sm flex-col justify-center space-y-6">
        ...
        {userIsAuthenticateWithSomeEmailInvite && (
        ...
        {isUserAuthenticated && !userIsAuthenticateWithSomeEmailInvite && (
